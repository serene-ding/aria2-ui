...
export default function Done({ client }: ClientProps) {
  ...
  return (
    <div className="DoneContainer">
      <div className="Header">
        <div className="buttonContainer" onClick={handleSelectAll}>
          <svg
        ...
        <div className="buttonContainer" onClick={handleDelete}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            viewBox="0 0 20 20"
